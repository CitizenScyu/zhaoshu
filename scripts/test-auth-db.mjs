...
import { personalMigrationCase, personalIsolationCase } from './personal-db-cases.mjs';
...
try {
  ...
  if (args.length && !['personal-migration','personal-isolation'].includes(testCase)) throw new Error('Unknown database test case');
